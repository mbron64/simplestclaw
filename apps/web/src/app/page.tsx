    ...
    <>
      <div className="mt-16 max-w-lg mx-auto">
        <button
          ...
          className="group relative text-left w-full p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:bg-white/[0.04] hover:border-white/20 transition-all"
        >
          <GlowingEffect
            spread={40}
            glow={true}
      ...
      <div className="mt-16 flex items-center justify-center gap-3 text-[13px] text-white/30">
