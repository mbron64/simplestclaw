...
const PROVIDER_INFO: Record<Exclude<Provider, null>, { name: string; placeholder: string; url: string }> = {
  anthropic: {
    name: 'Anthropic',
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            placeholder={selectedProvider ? PROVIDER_INFO[selectedProvider].placeholder : 'Select a provider first...'}
            ...
            autoFocus={runtimeReady && !!selectedProvider}
          />
          {selectedProvider && (
